...
/* ── Gallery ── */
const galleryImages = [
  { src: heroImage, alt: "Waste collection tricycle fleet" },
  { src: heroImage, alt: "Residential waste pickup in progress" },
  { src: heroImage, alt: "Construction site waste clearance" },
  { src: heroImage, alt: "Community clean-up event" },
];

/* ── Client Logos (placeholder text logos) ── */
const clientNames = [
  "TechVille Estates",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {services.map((s, i) => (
              <Card
                key={i}
                className="group shadow-card hover:shadow-eco border-transparent hover:border-primary/20 transition-all duration-300"
              >
                <CardContent className="p-6">
                  <div className="w-14 h-14 mb-4 rounded-xl bg-primary/10 text-primary flex items-center justify-center group-hover:bg-gradient-eco group-hover:text-primary-foreground transition-all duration-300">
                    {s.icon}
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 max-w-7xl mx-auto">
            {whyUs.map((item, i) => (
              <div key={i} className="text-center group">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-eco text-primary-foreground flex items-center justify-center shadow-eco group-hover:scale-110 transition-transform duration-300">
                  {item.icon}
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            {galleryImages.map((img, i) => (
              <div
                key={i}
                className="group relative rounded-xl overflow-hidden shadow-card hover:shadow-eco transition-all duration-300 aspect-[4/3]"
              >
                <img
                  src={img.src}
                  alt={img.alt}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 max-w-5xl mx-auto">
            {clientNames.map((name, i) => (
              <div
                key={i}
                className="flex items-center justify-center h-16 rounded-lg bg-background border border-border shadow-sm px-4"
              >
            ...
            <CardContent className="p-0">
              <div className="grid md:grid-cols-2">
                <div className="bg-gradient-eco text-primary-foreground p-8 md:p-10 flex flex-col justify-center">
                  ...
                  <h3 className="text-2xl font-bold mb-2">Stay Eco-Informed</h3>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact">
                <Button
                  size="lg"
                  className="text-lg px-8 py-6 gap-2 bg-primary text-primary-foreground hover:bg-primary-dark"
                >
              ...
              <a href="tel:+2348033036016">
                <Button
                  variant="outline"
                  size="lg"
                  className="text-lg px-8 py-6 gap-2 border-background/30 text-background hover:bg-background hover:text-foreground"
                >
