    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-2xl md:text-3xl font-semibold text-primary-foreground/95 mb-6 italic">
            Smart Waste, Clean Spaces
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <p className="text-primary-foreground/80 text-sm font-medium mb-2 sm:mb-0 sm:mr-4">
              Download our mobile app:
            </p>
            <div className="flex flex-col xs:flex-row gap-3">
              <a 
                href="#" 
                className="flex items-center justify-center bg-black hover:bg-gray-800 text-white rounded-lg px-4 py-3 min-w-[140px] transition-all duration-300 hover:scale-105"
